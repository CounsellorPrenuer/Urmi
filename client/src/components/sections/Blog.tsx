            ...
            <div className="overflow-hidden" ref={emblaRef}>
              <div className="flex gap-6">
                {blogPosts.map((post, index) => (
                  ...
                  >
                    <Card 
                      className="h-full flex flex-col glass-effect border border-card-border shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 hover:bg-orange-50/30 rounded-2xl overflow-hidden group cursor-pointer"
